...
def verify_data():
    ...
    try:
        ...
        print(f"Error verifying Checkins Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Photos Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Friends Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Visits Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Unconfirmed Visits Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Tips Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Comments Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Venue Ratings Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Expertise Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Plans Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Shares Table: {e}")
    ...
    try:
        ...
        print(f"Error verifying Venues Table: {e}")
